...
class Agent():
    ...
    def build_network(self):
        ...
        # inputs = Input(shape=(STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT), dtype=float32)
        # inputs = K.placeholder(shape=(None,STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT))
        s = tf.placeholder(tf.float32, [None, STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT])
        conv_1 = Convolution2D(32, 8, 8, subsample=(4, 4), activation='relu', input_shape=(STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT))(s)
        ...
        q_values = Lambda(lambda x,y:x+y-K.mean(y), arguments={'y':dense_advantage_out})(dense_value_out)
